Feature: Success Shopping E2E Test
  ...
  Scenario: Positive Shopping E2E Test
    ...
    When The user should be able to add item with item name: "Sauce Labs Backpack"
    Then The number on the basket icon should show added item quantity 2
    ...
    And The user should be able to verify total price with "Total: $86.38"
